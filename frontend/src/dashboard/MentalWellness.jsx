                ...
                <div className="space-y-4 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
                   {records.map(record => (
                     <div key={record._id || Math.random()} className="bg-black/40 border border-white/5 rounded-lg p-4">
                        ...
                        {record.aiFeedback && (
                           <div className="mt-3 bg-gradient-to-r from-pink-500/10 to-[#1FBCF9]/10 border border-[#1FBCF9]/20 p-3 rounded-lg text-sm text-gray-200">
                              <div className="flex items-center gap-2 mb-1">
                                 <span className="text-[#1FBCF9]">🩺</span>
                                 <span className="font-bold text-[#1FBCF9]">Dr. Arogya (Virtual Psychologist)</span>
                              </div>
                              <p className="leading-relaxed whitespace-pre-wrap">{record.aiFeedback}</p>
                           </div>
                        )}
                     </div>
                   ))}
